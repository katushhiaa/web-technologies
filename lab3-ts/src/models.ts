...
export class Book implements IBook{
    ...
    get borrowedBy(): string | undefined { return this._borrowedBy; }
    get isBorrowed(): boolean { return !!this._borrowedBy; }

    /* mutators (керовано міняємо стан)*/
    markBorrowedBy(userId: string): void { this._borrowedBy = userId; }
    markReturned(): void { this._borrowedBy = undefined; }
...
export class User implements IUser{
    ...
    incrementBorrowed(): void { this._borrowedCount += 1; }
    decrementBorrowed(): void { this._borrowedCount = Math.max(0, this._borrowedCount - 1); }
